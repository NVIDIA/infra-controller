...
<tr><td>carbide_hosts_health_status_count</td><td>gauge</td><td>The total number of objects in the system that have reported either a healthy or not healthy status - based on the presence of health probe alerts</td></tr>
...
<tr><td>carbide_power_shelves_health_status_count</td><td>gauge</td><td>The total number of objects in the system that have reported either a healthy or not healthy status - based on the presence of health probe alerts</td></tr>
...
<tr><td>carbide_racks_health_status_count</td><td>gauge</td><td>The total number of objects in the system that have reported either a healthy or not healthy status - based on the presence of health probe alerts</td></tr>
...
<tr><td>carbide_switches_health_status_count</td><td>gauge</td><td>The total number of objects in the system that have reported either a healthy or not healthy status - based on the presence of health probe alerts</td></tr>
