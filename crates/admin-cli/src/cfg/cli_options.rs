...
use crate::{
    ...
    expected_rack, expected_switch, extension_service, firmware, firmware_object,
...
pub enum CliCommand {
    ...
    #[clap(
        about = "Firmware object management",
        subcommand,
        visible_alias = "fw-object"
    )]
    FirmwareObject(firmware_object::Cmd),
